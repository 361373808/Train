...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script language="javascript">
           function checiDel(c_id)
           {
               if(confirm('您确定删除吗？'))
               {
                   window.location.href="<%=path %>/ManagerAction?op=dc&c_id="+c_id;
               }
           }
	...
	<body leftmargin="2" topmargin="2" background='<%=path %>/img/allbg.gif'>
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				...
				<s:iterator value="#session.list" id="checi">
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					...
					<td bgcolor="#FFFFFF" align="center">
					    <a href="<%=path %>/ManagerAction?op=ec&c_id=<s:property value="#checi.c_id"/>">编辑</a>
					    &nbsp;&nbsp;&nbsp;&nbsp;
						<a href="#" onclick="checiDel(<s:property value="#checi.c_id"/>)" class="pn-loperator">删除</a>
					</td>
				</tr>
				</s:iterator>
			</table>
