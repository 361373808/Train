...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script language="javascript">
            function check()
            {
                 var userPwReal="${sessionScope.tu.u_pw}";
	...
	<body leftmargin="2" topmargin="9" background='<%=path %>/img/allbg.gif'>
			<form method="post" action="<%=path %>/PersonalAction?op=ppw" name="formPw">
			<table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px">
				...
				<tr bgcolor="#FFFFFF">
				    ...
				    <td width="75%" bgcolor="#FFFFFF">
				        <input type="text" value="${sessionScope.tu.u_name }"  name="username" size="20" disabled="disabled"/>
				        <input type="hidden" value="${sessionScope.tu.u_name }"  name="name" />
				    </td>
				</tr>
				<tr bgcolor="#FFFFFF">
				    <td width="25%" bgcolor="#FFFFFF" align="right">
